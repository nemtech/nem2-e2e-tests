...
public class AuthenticatedSocket {
   ...
   */
  public AuthenticatedSocket(final SocketClient socket, final PublicKey publicKey, final PrivateKey privateKey) {
  ...
  public static AuthenticatedSocket create(
      final SocketClient socketClient, final PublicKey publicKey, final PrivateKey privateKey) {
    if (authenticatedSocket == null) {
      authenticatedSocket = new AuthenticatedSocket(socketClient, publicKey, privateKey);
    }
