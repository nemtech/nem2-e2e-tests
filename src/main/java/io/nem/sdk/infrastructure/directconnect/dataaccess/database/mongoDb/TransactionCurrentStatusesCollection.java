...
import io.nem.sdk.infrastructure.directconnect.dataaccess.mappers.TransactionStatusMapper;
...
public class TransactionCurrentStatusesCollection implements TransactionCurrentState {
  ...
  /* Catapult collection */
  private final CatapultCollection<TransactionStatus, TransactionStatusMapper>
      catapultCollection;
